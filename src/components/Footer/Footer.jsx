...
const Footer = () => {
  return (
    <div className=" bg-black">
          ...
          <div className="grid grid-flow-col gap-4">
            ...
            <a>
              <svg
                ...
                height="24"
                viewBox="0 0 24 24"
                className="fill-current text-white bg-blue-600 rounded-full p-1"
              >
      ...
      <footer className="footer container mx-auto px-10 py-4 pb-12 border-t bg-black text-white border-base-300">
        <div className="items-center grid-flow-col">
            <a href="">@2023 CareerHub. All Rights Reserved</a>
        </div>
        <div className="md:place-self-center md:justify-self-end">
        <a>Powered by Job-Hunter</a>
        </div>
      </footer>
    </div>
  );
